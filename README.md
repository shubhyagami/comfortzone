...
ComfortZone is a lightweight, cross‑platform toolkit that logs environmental sensor data (temperature, humidity, ambient noise) alongside user‑reported mood scores. The data is visualised on a live‑refreshing dashboard and can be backed up automatically on a schedule you define.
...
Using a virtual environment isolates the Python dependencies; you may also install the backend system‑wide if preferred.
...
- **2026‑09‑25** – README cleanup, added quick‑start guide and updated configuration section.  
